...
b_etas = None
n_epochs = 5
n_training_examples = 1000 # use at least 1000 examples!

# create the network -- this will also load the MNIST dataset files
net = dl.Network(n=(100, 100, 10)) # two 100-neuron hidden layers and one 10-neuron output layer
...
net, f_etas, b_etas, n_training_examples = dl.load_simulation(latest_epoch=n_epochs-1, folder_name="Example Simulation", simulations_folder="Simulations")

# train the network for another n_epochs
net.train(f_etas, b_etas, n_epochs, n_training_examples, save_simulation=True, simulations_folder="Simulations", folder_name="Example Simulation")